...
const calculateBMI = (hightCM, weightKG) => {
  let heightInMeters = hightCM / 100;
  let bmi = (weightKG / (heightInMeters**2)).toFixed(2);
  return `${bmi}`
}

console.log(calculateBMI(180, 80)); // "24.69"
console.log(typeof calculateBMI(180, 80)); // "24.69"